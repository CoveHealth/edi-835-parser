...
from edi_parser.common.elements.service_qualifier import ServiceQualifier
from edi_parser.common.elements.service_code import ServiceCode
from edi_parser.common.elements.service_modifier1 import ServiceModifier1
from edi_parser.common.elements.service_modifier2 import ServiceModifier2
from edi_parser.common.elements.service_modifier3 import ServiceModifier3
from edi_parser.common.elements.service_modifier4 import ServiceModifier4
...
class ServiceProfessional:
	...
	def __init__(self, segment: str):
		...
		self.unit = get_element(segment, 3)
